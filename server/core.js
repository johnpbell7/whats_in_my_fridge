...
- category must be exactly one of: ${CATEGORIES.join(', ')}. Use the most specific fit: ALL fresh fruit and vegetables -> produce, including less common ones (e.g. mango, pomegranate, pineapple, kiwi, papaya, fig, melon, rhubarb, okra, aubergine, butternut squash, sweet potato, pak choi) — never put a recognisable fruit or vegetable in 'other'; fresh herbs and salad -> produce; milk, cheese, yoghurt, eggs, butter, cream -> dairy; meat, poultry and fish -> meat; juice, soft drinks, water, coffee and tea -> drinks; bread and baked goods -> bakery; crisps, chocolate, biscuits, sweets -> snacks; cleaning products, toiletries, personal care and medicine -> household; salt, pepper, dried or ground herbs and spices, stock cubes, gravy granules and seasoning blends -> seasoning; tobacco, cigarettes, rolling tobacco, nicotine pouches, snus, vapes and e-cigarettes -> other (never produce or snacks). Only use 'other' when nothing else genuinely fits.
...
- frozen is true ONLY with clear evidence the product is frozen: its packaging says "frozen", it's clearly inside a freezer, or it's a product sold only frozen (ice cream, fish fingers, oven chips, frozen ready meals). Fresh whole fruit and vegetables (a loose lemon, apple, banana, salad, fresh herbs) are NOT frozen. If in any doubt, set false.
...
- Estimate the calories PER SERVING (caloriesPerServing, whole number). Work it out properly: add up the calories of EVERY ingredient at its scaled quantity — including the calorie-dense ones people forget (oil ~120 kcal/tbsp, butter ~100 kcal/tbsp, cheese, cream, nuts, honey/sugar, and the meat/fish, rice/pasta/potatoes and bread) plus any cooking fat the steps use — then divide by the number of servings. Don't undercount: a substantial meat-or-fish main with a carb and sides is typically ~600-900 kcal per serving; a hearty roast or creamy/cheesy dish often 700-1000+; a light salad or soup ~300-450. If your figure for a filling main lands under ~500, you've likely missed the oil, carbs or sides — recount. It's a rough guide, so round to the nearest ~10 kcal and never imply false precision.`
