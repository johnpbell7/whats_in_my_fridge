...
- category must be exactly one of: ${CATEGORIES.join(', ')}. Use the most specific fit: fresh herbs, salad, vegetables and fruit -> produce; milk, cheese, yoghurt, eggs, butter, cream -> dairy; meat, poultry and fish -> meat; juice, soft drinks, water, coffee and tea -> drinks; bread and baked goods -> bakery; crisps, chocolate, biscuits, sweets -> snacks; cleaning products, toiletries, personal care and medicine -> household; salt, pepper, dried or ground herbs and spices, stock cubes, gravy granules and seasoning blends -> seasoning; tobacco, cigarettes, rolling tobacco, nicotine pouches, snus, vapes and e-cigarettes -> other (never produce or snacks). Only use 'other' when nothing else genuinely fits.
