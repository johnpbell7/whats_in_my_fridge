...
export default function SafetyNote({ style, calories = false }) {
  return (
    <p className="safety-note" style={style}>
      ...
      allergens yourself.
      {calories && (
        <> Calorie figures are a rough estimate to help you choose — not precise nutritional or dietary advice.</>
      )}
    </p>
  )
}
